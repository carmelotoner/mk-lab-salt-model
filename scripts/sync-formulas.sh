...
[ ! -d /srv/salt/env/dev ] && mkdir -p /srv/salt/env/dev
[ ! -L /usr/share/salt-formulas/env/ /srv/salt/env/dev/ ] && ln -s  /usr/share/salt-formulas/env/ /srv/salt/env/dev/
[ ! -d /srv/salt/reclass/classes/service ] && mkdir -p /srv/salt/reclass/classes/service

declare -a formula_services=("linux" "reclass" "salt" "openssh" "ntp" "git" "nginx" "collectd" "sensu" "heka" "sphinx" "keystone" "mysql" "grafana" "haproxy" "horizon" "libvirt" "memcached" "rabbitmq" "keepalived" "glusterfs" "glance" "keystone" "cinder" "nova" "neutron" "heat" "opencontrail" "galera" "redis" "graphite" "postgresql" "apache" "supervisor" "java" "elasticsearch" "kibana")
